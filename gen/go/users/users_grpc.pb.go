...
const (
	Users_Create_FullMethodName             = "/userspb.Users/Create"
	Users_GetCurrentUser_FullMethodName     = "/userspb.Users/GetCurrentUser"
	Users_GetByID_FullMethodName            = "/userspb.Users/GetByID"
	Users_Find_FullMethodName               = "/userspb.Users/Find"
	Users_Update_FullMethodName             = "/userspb.Users/Update"
	Users_SetSuperuserStatus_FullMethodName = "/userspb.Users/SetSuperuserStatus"
)
...
func (c *usersClient) GetCurrentUser(ctx context.Context, in *GetCurrentUserRequest, opts ...grpc.CallOption) (*GetCurrentUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Users_GetCurrentUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) SetSuperuserStatus(ctx context.Context, in *SetSuperuserStatusRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Users_SetSuperuserStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Users_GetCurrentUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_GetCurrentUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Users_SetSuperuserStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Users_SetSuperuserStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
