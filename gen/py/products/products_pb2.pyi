...
class FindCharacteristicsRequest(_message.Message):
    __slots__ = ("limit", "search", "ids", "offset", "category_id")
    ...
    offset: int
    category_id: str
    def __init__(self, limit: _Optional[int] = ..., search: _Optional[str] = ..., ids: _Optional[_Iterable[str]] = ..., offset: _Optional[int] = ..., category_id: _Optional[str] = ...) -> None: ...
...
class Product(_message.Message):
    __slots__ = ("id", "name", "category_id", "description", "unit_of_measurement", "vat", "old_price", "discount_ratio", "price", "is_visible", "updated_at", "images", "created_at", "product_characteristics", "tags")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    CATEGORY_ID_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
